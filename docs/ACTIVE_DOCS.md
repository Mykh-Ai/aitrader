...
Active docs are only reset / feed contract / Market State Monitor docs.
...
Old Analyzer v1 / Phase2 / Phase3 / Backtester docs are archived historical references and must not be used as current implementation plan.
